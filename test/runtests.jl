...
@testset "Ressac.jl" begin
    ...
    include("test_ui_integration.jl")
    include("test_visual_integration.jl")
    ...
    include("test_genome_validity.jl")
    include("test_genome_render.jl")
    include("test_nrt_analysis.jl")
    include("test_synth_roles.jl")
    include("test_synth_explainer.jl")
    include("test_genome_archetypes.jl")
    include("test_genome_operators.jl")
    include("test_ga_engine.jl")
    include("test_ga_targeting.jl")
    include("test_ga_analysis.jl")
    include("test_synth_audition.jl")
    include("test_synth_explorer_pane.jl")
